...
to the public under the project's open source [license](https://github.com/EMOD-Hub/emodpy-malaria/blob/main/LICENSE).

Review the [documentation](https://emod.idmod.org/emodpy-malaria) before you begin.
Additionally, this content is also included in the following README files:

- [Project README](https://github.com/EMOD-Hub/emodpy-malaria/blob/main/README.md): Setup and project overview.
...
2. Pull requests:
   ...
   - Documentation improvements in the [docs](https://github.com/EMOD-Hub/emodpy-malaria/tree/main/docs) folder.
...
If you notice unexpected behavior or a limitation in emodpy-malaria, follow the
steps below before requesting a new feature or reporting a bug.

1. First, review the [emodpy-malaria documentation](https://emod.idmod.org/emodpy-malaria)
...
2. Install emodpy-malaria on your machine (see [Developer installation](#developer-installation) below).
