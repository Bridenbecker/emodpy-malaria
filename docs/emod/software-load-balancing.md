...
$i^{th}$ entry in the series is equal to the cumulative proportion of the processing load for
all the previous nodes 0 through $i$.
...
![loadbalancingBFF.jpg](../figures/file-structure/loadbalancingBFF.jpg)
