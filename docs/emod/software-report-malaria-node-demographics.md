...
report (see [ReportNodeDemographics](software-report-node-demographics.md)) by adding malaria-specific statistics. The
...
| Time | NodeID | Gender | AgeYears | IndividualProp=StudyGroups | HasClinicalSymptoms | NumIndividuals | NumInfected | AvgInfectiousness | AvgParasiteDensity | AvgGametocyteDensity | AvgVariantFractionPfEMP1Major | AvgNumInfections | AvgInfectionClearedDuration | NumInfectionsCleared | NumHasFever |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
