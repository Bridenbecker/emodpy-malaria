...
| `Subchannel_Metadata` | nested JSON object | A collection of parameters defining the contents of the channel data. See the table below for its sub-parameters. |
...
| Parameter | Data type | Description |
| --- | --- | --- |
| `<Channel_Title>` | string | The title of the particular channel. See the table below for possible channels. |
...
Possible values for `<Channel_Title>`:
...
```json
{
    "Header": {
        ...
        "Timesteps": 5,
        "Subchannel_Metadata": {
            "AxisLabels": [["Species:Habitat"]],
            "NumBinsPerAxis": [[3]],
            "ValuesPerAxis": [[[0, 0, 0]]],
            "MeaningPerAxis": [[["gambiae:TEMPORARY_RAINFALL", "funestus:WATER_VEGETATION", "arabiensis:TEMPORARY_RAINFALL"]]]
        },
        "Channels": 7
    },
    "Channels": {
        ...
        "Current Habitat Capacity": {
            "Units": "",
            "Data": [
                [402.5242614746, 469.3384094238, 482.3938293457, 730.068359375, 718.5045776367],
                [195.2786865234, 230.9520568848, 242.8811035156, 376.0362548828, 384.9170837402],
                [3622.71875, 4224.045898438, 4341.544433594, 6570.615234375, 6466.541503906]
            ]
        },
        "Egg Crowding Factor": {
            "Units": "",
            "Data": [
                [1, 0.1548170298338, 0.01222433708608, 0.03274614363909, 0.212905973196],
                [1, 0.1394847780466, 0.03747003525496, 0.0134865026921, 0.1550362557173],
                [1, 1, 1, 1, 1]
            ]
        },
