...
![Anopheles mosquito](figures/jorussell-mosquito.png){ align=right style="width: 200px; margin-left: 2em; margin-bottom: 1em;" }
...
that simulates the spread of infectious diseases. It models individual humans and mosquitoes and their interactions,
making it well-suited for evaluating malaria control strategies across a wide range of transmission settings.
See the [Malaria Overview](emod/malaria-overview.md) for a full description of the model.
